...
public class LoginGUI extends JFrame{
	...
	StudentHome frame1;
	static StudentHome obj;
	static AdminHome obj2;
	static GuestHome obj3;
	...
	private void initialize() {
		...
		frame.addWindowListener(new WindowAdapter() {
			...
			public void windowActivated(WindowEvent arg0) {
				...
				if(Driver.gcontrol==1)
					obj3.setVisible(false);
				
					//obj2=Driver.aobj;
				//if(Driver.acontrol==1)
					//obj2.frmAdminHome.setVisible(false);
			}
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				case "Student Check-in":
					...
					if(checklogin){
						...
						boolean eaten=user.getHasEaten(username);
						if(eaten==true)
						JOptionPane.showMessageDialog( frame,"This Student has already eaten");
						else
							JOptionPane.showMessageDialog( frame,"Illegal Checkin");	
					}
					break;
				...
				case "Mess Crew Login":
					...
					if(checklogin){
						...
						MessWorker.username=username;
						Driver.cusermess=mymess;
						System.out.println(Driver.cusermess);
						messWorker.run();
						frame.setVisible(false);
